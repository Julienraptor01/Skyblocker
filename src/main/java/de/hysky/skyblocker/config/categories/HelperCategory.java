		...
		return ConfigCategory.createBuilder()
				...
				.group(OptionGroup.createBuilder()
						...
						.option(Option.<Boolean>createBuilder()
								...
								.build())
						.option(Option.<Float>createBuilder()
								.name(Text.translatable("skyblocker.config.helpers.chocolateFactory.timeTowerEfficiency"))
								.description(OptionDescription.of(Text.translatable("skyblocker.config.helpers.chocolateFactory.timeTowerEfficiency.@Tooltip")))
								.binding(defaults.helpers.chocolateFactory.timeTowerEfficiency,
										() -> config.helpers.chocolateFactory.timeTowerEfficiency,
										newValue -> config.helpers.chocolateFactory.timeTowerEfficiency = newValue)
								.controller(opt -> FloatSliderControllerBuilder.create(opt)
										.range(0f, 1f)
										.step(0.005f)
										.formatValue(v -> Text.of(String.format("%.1f%%", v * 100))))
								.build())
						.option(Option.<Boolean>createBuilder()
